            ...
            <div class="sidebar-categories">
                ...
                <ul class="main-categories">
                    <li class="main-nav-list">
                        ...
                        <a class="number"  class="lnr lnr-arrow-right" href="/products" value="">All</a>
                    </li>
                </ul>
                <%
                ...
                <ul class="main-categories">
                    <li class="main-nav-list">
<%--                        <a data-toggle="collapse"aria-expanded="false" aria-controls="fruitsVegetable" >--%>
                        <a class="number"  class="lnr lnr-arrow-right" href="/filter/cate?id=<%=category.getId()%>" value="<%=category.getId()%>"><%=category.getName()%></a>
                    </li>
                </ul>
                <option  ></option>
                <%}%>
        ...
        <div class="col-xl-9 col-lg-8 col-md-7">
            ...
            <div class="filter-bar d-flex flex-wrap align-items-center">
                <div class="sorting">
                    <select>
                    <option value="0" href="/products">All</option>
                    <%
                        for (int i = 0; i < categories.size(); i++) {
                            Category category = categories.get(i);
                    %>

                        <option  value="<%=category.getId()%>" href="/filter/cate?id=<%=category.getId()%>%"><%=category.getName()%></option>
                    <%}%>
                    </select>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="<%=product.getThumbnail()%>" alt="" style="max-width: 250px">
                            <div class="product-details">
                                ...
                                <div class="prd-bottom">
                                    ...
                                    <a href="/cart/add?id=<%=product.getId()%>&qty=1" class="social-info">
                                        <span class="ti-bag"></span>
                                        <p class="hover-text">add to bag</p>
                                    </a>
                                    <a href="/products/detail?id=<%=product.getId()%>" class="social-info">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="quick-view-carousel">
                            <div class="item" style="background: url(/user/img/organic-food/q1.jpg);">
