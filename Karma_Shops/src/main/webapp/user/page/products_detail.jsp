            ...
            <div class="col-lg-6">
                <div class="s_Product_carousel">
                    <div class="single-prd-item">
                        <img class="img-fluid" src="<%=product.getThumbnail()%>" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-5 offset-lg-1">
                <div class="s_product_text">
                    ...
                    <ul class="list">
                        ...
                        <%if (product.getCategoryId() == category.get(i).getId()){%>
                        <li><a class="active" href="#"><span>Category : </span><%=category.get(i).getName()%></a></li>
                        <%}else{%>
                        <%}}%>
                    </ul>
                    ...
                    <div class="card_area d-flex align-items-center">
                        <a class="primary-btn" href="/cart/add?productId=<%=product.getId()%>&qty=1">Add to Cart</a>
                    ...
                    <div class="col-lg-6">
                        <div class="comment_list">
                            ...
                            <div class="review_item reply">
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="/user/img/product/review-2.png" alt="">
                                    </div>
                                    <div class="media-body">
                                        <h4>Blake Ruiz</h4>
                                        <h5>12th Feb, 2018 at 05:56 pm</h5>
                            ...
                            <div class="review_item">
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="/user/img/product/review-3.png" alt="">
                                    </div>
                                    <div class="media-body">
                                        <h4>Blake Ruiz</h4>
                                        <h5>12th Feb, 2018 at 05:56 pm</h5>
